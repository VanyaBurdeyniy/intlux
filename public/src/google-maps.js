...
(function() {
    ...
    google.maps.Load = function(apiLoad) {
        ...
        apiLoad([0.009999999776482582, [
            [
                ["http://mt0.googleapis.com/maps/vt?lyrs=m@365000000\u0026src=api\u0026hl=en-US\u0026", "http://mt1.googleapis.com/maps/vt?lyrs=m@365000000\u0026src=api\u0026hl=en-US\u0026"], null, null, null, null, "m@365000000", ["https://mts0.google.com/maps/vt?lyrs=m@365000000\u0026src=api\u0026hl=en-US\u0026", "https://mts1.google.com/maps/vt?lyrs=m@365000000\u0026src=api\u0026hl=en-US\u0026"]
            ],
            [
                ["http://khm0.googleapis.com/kh?v=701\u0026hl=en-US\u0026", "http://khm1.googleapis.com/kh?v=701\u0026hl=en-US\u0026"], null, null, null, 1, "701", ["https://khms0.google.com/kh?v=701\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=701\u0026hl=en-US\u0026"]
            ], null, [
                ["http://mt0.googleapis.com/maps/vt?lyrs=t@365,r@365000000\u0026src=api\u0026hl=en-US\u0026", "http://mt1.googleapis.com/maps/vt?lyrs=t@365,r@365000000\u0026src=api\u0026hl=en-US\u0026"], null, null, null, null, "t@365,r@365000000", ["https://mts0.google.com/maps/vt?lyrs=t@365,r@365000000\u0026src=api\u0026hl=en-US\u0026", "https://mts1.google.com/maps/vt?lyrs=t@365,r@365000000\u0026src=api\u0026hl=en-US\u0026"]
            ], null, null, [
                ["http://cbk0.googleapis.com/cbk?", "http://cbk1.googleapis.com/cbk?"]
            ],
            [
                ["http://khm0.googleapis.com/kh?v=100\u0026hl=en-US\u0026", "http://khm1.googleapis.com/kh?v=100\u0026hl=en-US\u0026"], null, null, null, null, "100", ["https://khms0.google.com/kh?v=100\u0026hl=en-US\u0026", "https://khms1.google.com/kh?v=100\u0026hl=en-US\u0026"]
            ],
            [
            ...
            ["http://maps.google.com/maps-api-v3/api/js/26/2", "3.26.2"],
            [289481738], 1, null, null, null, null, null, "", null, null, 0, "http://khm.googleapis.com/mz?v=701\u0026", null, "https://earthbuilder.googleapis.com", "https://earthbuilder.googleapis.com", null, "http://mt.googleapis.com/maps/vt/icon", [
                ["http://maps.google.com/maps/vt"],
                ["https://maps.google.com/maps/vt"], null, null, null, null, null, null, null, null, null, null, ["https://www.google.com/maps/vt"], "/maps/vt", 365000000, 365
            ...
            ["https://www.google.com/maps/api/js/master?pb=!1m2!1u26!2s2!2sen-US!3sUS!4s26/2", "https://www.google.com/maps/api/js/widget?pb=!1m2!1u26!2s2!2sen-US"], null, 0, null, "/maps/api/js/ApplicationService.GetEntityDetails", 0, null, null, [null, null, null, null, null, null, null, null, null, [0, 0]], null, [],
            ["26.2"]
        ], loadScriptTime);
    };
...
(function(_) {
    ...
    _.ad = function() {
        this.S = new Yc({
            ud: (0, _.v)(this.ud, this),
            wd: (0, _.v)(this.wd, this)
        })
    };
    _.bd = function() {
        _.ad.call(this)
    ...
    _.ze = function(a, b, c) {
        function d(a) {
            ...
            var d = a.properties || {};
            if (!_.cb(d)) throw _.Eb("properties is not an Object");
            var f = c.idPropertyName;
            a = f ? d[f] : a.id;
            if (null != a && !_.C(a) && !_.db(a)) throw _.Eb((f || "id") + " is not a string or number");
            return {
                id: a,
                geometry: b,
                properties: d
    ...
    _.r.set = function(a, b) {
        ...
        var d = hb(c, a);
        if (d)
            if (a = d.jb, d = d.Gc, c = "set" + _.Bb(a), d[c]) d[c](b);
            else d.set(a, b);
    ...
    Yc.prototype.addListener = function(a, b, c) {
        ...
        var d = !this.S.length,
            e = _.Qa(this.S, Xc(a, b));
        e ? e.xd = e.xd && c : this.S.push({
            Cc: a,
            context: b || null,
            xd: c
        });
    ...
    qg.prototype.next = function() {
        do qg.Sb.next.call(this); while (-1 == this.f);
        return this.node
    };
    ...
    window.google.maps.Load(function(a, b) {
        ...
        _.Ri = new _.zc;
        _.dg = b;
        for (a = 0; a < _.gd(_.Q.b, 8); ++a) _.Zf[rf(a)] = !0;
        a = new _.$e(_.Q.b[3]);
        oe(kf(a));
